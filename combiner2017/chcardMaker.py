...
parseOptions()
if(opt.config==""): configname = "../config/mainCfg_"+opt.channel+".cfg" #JAIME 
...
for il in range(len(input.signals)) :
  ...
  input.signals[il] = input.signals[il].replace("HHSM","ggHH_bbtt") # JAIME	
